...
describe('folkhalsomyndigheten tool handlers', () => {
  ...
  it('about returns correct agency and gazette', () => {
    ...
    expect(result.agency).toBe('FoHM');
    expect(result.gazette).toBe('FoHMFS');
    expect(result.server).toBe('swedish-public-health-mcp');
